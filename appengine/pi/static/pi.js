...
function CalcPiTask (jobsarray, misc) {
  var primearray = [], functionname = arguments.callee.name, n = bigjob * 9 + 1;
  ...
  function send(id, data){
    ...
    if(jobsarray==null){return send('init','init')}

  
    id = jobsarray[0]
    bigjob = jobsarray[1]
    primecount = jobsarray[2]
